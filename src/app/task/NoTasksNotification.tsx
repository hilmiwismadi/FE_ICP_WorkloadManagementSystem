...
const NoTasksNotification: React.FC<{ isOpen: boolean; onClose: () => void; onOpenModal: () => void }> = ({ isOpen, onClose, onOpenModal }) => {
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="flex flex-col items-center justify-center px-[3vw] pt-[1vw] pb-[1.5vw]">
          ...
          <button className="mt-4 px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700" onClick={() => { onOpenModal(); onClose(); }}>
            Assign Task
          </button>
        </div>
      </DialogContent>
